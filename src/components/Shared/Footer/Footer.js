                    ...
                    <FooterCol key={4} menuTitle="Our Address" menuItems={ourAddress}>
                        <ul className="social-icon list-inline">
                            <li className="list-inline-item">
                                <a href="//facebook.com"><FontAwesomeIcon className="icon active-icon" icon={faGooglePlusG} /> </a>
                            </li>
                            <li className="list-inline-item">
                                <a href="//facebook.com"><FontAwesomeIcon className="icon" icon={faFacebookF} /> </a>
                            </li>
                            <li className="list-inline-item">
                        ...
                        <div className="mt-5">
                            <h6>Call now</h6>
                            <button className="btn-style">+1569-568 362</button>
                        </div>
                    </FooterCol>
                </div>
